...
folder_path = '/Users/souvikchakraborty/Downloads/Project/FSRCPSP_Codes/FSRCPSP_Codes/Instances_Folder/Instanzen_j10_FSRCPSP_complete' 
#TODO
#folder_path = '/Users/bhanu/Desktop/Thesis 2.0/Instances_Folder/Instances_j10_FSRCPSP'  # Replace with the actual folder path
...
def main():
    ...
    for file in folder.iterdir():
        if file.is_file() and not file.name.startswith('.'):
            ...
            if file_name_without_extension in ["j103_5"]:
...
def schedule_activities_fn(total_activities_count, unified_preced_array,
    ...
    #   folder_path = '/Users/bhanu/Desktop/Thesis 2.0/output_folder'
      folder_path = '//Users/souvikchakraborty/Downloads/Project/FSRCPSP_Codes/FSRCPSP_Codes/output_folder_stochstic'
    ...
    #   model.heuristics = 1
      ...
      model.Heuristics = 1  # Enable heuristics
    #   model.params.HeuristicsMode = 1  # Aggressive heuristics mode
